...
const BusinessKYCScreen = ({ navigation }) => {
  ...
  const handleSubmit = async () => {
    ...
    const hasFile = isGst
      ? formData.gstFile || selectedGst
      : formData.panFile || selectedPan;
    ...
    if (
      ...
      Alert.alert(
        'Error',
        `Please fill all required fields (Shop Name, Type, Address, and ${
          isGst ? 'GST' : 'PAN'
        })`,
      );
      return;
    ...
    if (!hasFile) {
      Alert.alert(
        'Document Required',
        `Please upload your ${isGst ? 'GST' : 'PAN'} image`,
      );
      return;
    }
    ...
    <View style={styles.container}>
          ...
          >
            ...
            <View style={styles.statusTextContainer}>
              ...
              <Text style={styles.statusDesc}>
                Your business account is verified. You now have access to
        ...
        <View style={styles.formSection}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TouchableOpacity
              style={[
                styles.uploadBox,
                (formData.shopPhoto || selectedShopPhoto) && styles.uploadedBox,
                user?.businessDetails?.verificationStatus === 'Approved' && {
                  opacity: 0.7,
                },
              ]}
            ...
            >
              <MaterialIcons
                name={
                  formData.shopPhoto || selectedShopPhoto
                    ? 'check-circle'
                    : 'storefront'
                }
                size={32}
          ...
          <View style={styles.inputGroup}>
            ...
            >
              ...
              <MaterialIcons
                name={
                  showKycPicker ? 'keyboard-arrow-up' : 'keyboard-arrow-down'
                }
                size={24}
                color={'#64748B'}
              />
            ...
            {showKycPicker && (
              <View style={styles.optionsContainer}>
                <TouchableOpacity
                  style={[
                    styles.optionItem,
                    kycType === 'GST' && styles.selectedOption,
                  ]}
                  onPress={() => {
                    setKycType('GST');
                    setShowKycPicker(false);
                  }}
                >
                  <Text
                    style={[
                      styles.optionText,
                      kycType === 'GST' && styles.selectedOptionText,
                    ]}
                  >
                    GST Number
                  </Text>
                ...
                <TouchableOpacity
                  style={[
                    styles.optionItem,
                    kycType === 'PAN' && styles.selectedOption,
                  ]}
                  onPress={() => {
                    setKycType('PAN');
                    setShowKycPicker(false);
                ...
                >
                  <Text
                    style={[
                      styles.optionText,
                      kycType === 'PAN' && styles.selectedOptionText,
                    ]}
                  >
                    PAN Card
                  </Text>
            ...
            <View style={{ gap: 20 }}>
              ...
              <View style={styles.inputGroup}>
                ...
                <TouchableOpacity
                  style={[
                    styles.uploadBox,
                    (formData.gstFile || selectedGst) && styles.uploadedBox,
                    user?.businessDetails?.verificationStatus ===
                      'Approved' && { opacity: 0.7 },
                  ]}
            ...
            <View style={{ gap: 20 }}>
              ...
              <View style={styles.inputGroup}>
                ...
                <TouchableOpacity
                  style={[
                    styles.uploadBox,
                    (formData.panFile || selectedPan) && styles.uploadedBox,
                    user?.businessDetails?.verificationStatus ===
                      'Approved' && { opacity: 0.7 },
                  ]}
      ...
      >
        <TouchableOpacity
          ...
          disabled={
            loading || user?.businessDetails?.verificationStatus === 'Approved'
          }
        >
          {loading ? (
