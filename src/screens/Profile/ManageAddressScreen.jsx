...
import { setDefaultAddressAsync, deleteAddressAsync, fetchAddresses } from '../../redux/slices/addressSlice';
    ...
    return (
        <View style={[styles.container, isDarkMode && styles.darkContainer]}>
            ...
            <View style={[styles.header, isDarkMode && styles.darkHeader, { paddingTop: Math.max(insets.top, 16) }]}>
                ...
                <Text style={[styles.headerTitle, isDarkMode && styles.darkText]}>Manage Addresses</Text>
            ...
            <ScrollView contentContainerStyle={[styles.scrollContent, { paddingBottom: 100 + insets.bottom }]}>
                ...
                {addresses.map((addr) => (
                    <View key={addr._id || addr.id} style={[styles.addressCard, isDarkMode && styles.darkCard, addr.isDefault && styles.defaultCard]}>
                        {addr.isDefault && (
                        ...
                        <View style={styles.cardHeader}>
                            <View style={styles.labelRow}>
                                <View style={[styles.iconBg, isDarkMode && styles.darkIconBg]}>
                                    <MaterialIcons name={getLabelIcon(addr.label)} size={20} color="#2E7D32" />
                                </View>
                                <Text style={[styles.labelText, isDarkMode && styles.darkText]}>{addr.label}</Text>
                            </View>
                            <View style={styles.actionRow}>
                                ...
                                >
                                    <MaterialIcons name="edit" size={20} color={isDarkMode ? "#94A3B8" : "#64748B"} />
                                </TouchableOpacity>
                                {!addr.isDefault && (
                                    <TouchableOpacity 
                                        style={styles.actionBtn}
                        ...
                        <View style={styles.cardBody}>
                            <Text style={[styles.nameText, isDarkMode && styles.darkText]}>{addr.name}</Text>
                        ...
                        {!addr.isDefault && (
                            <TouchableOpacity 
                                style={[styles.setDefaultBtn, isDarkMode && styles.darkSetDefaultBtn]}
